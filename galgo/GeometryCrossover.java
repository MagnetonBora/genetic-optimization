...
public class GeometryCrossover implements GeneticOperator {

	private double probability;
	private double weight;
	
	public GeometryCrossover() {
		super();
		probability = 0.5;
		weight = 0.5;
	}

	public GeometryCrossover(double probability, double weight) {
		super();
	...
	private void doGeometryCrossover(Population p) {
